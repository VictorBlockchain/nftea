...
contract HONEY is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    address public TEAPASS = 0x99cE0b1f3404777087E077BB072e3836F35042E6;
    ...
    function addHoney(uint256 _nft) public {
      ...
      address _contract = IERC1155(NFTEA)._N2_V(_nft);
      require(_C2_N2_value[msg.sender][_contract]<1, 'you already added honey');
             (,,,uint256 _power,) = IERC1155(TEAPASS).getProfile(msg.sender);
      require(_power>0,'you do not have that much power');
      require(IERC20(TEATOKEN).balanceOf(msg.sender)>0,'you must have tea tokens to do this');

      bool success = IERC1155(TEAPOT).disValue(_contract,_power,TEATOKEN);
      if(success){
        ...
        IERC1155(TEAPASS).setPower(msg.sender,1000,2);
      }
